...
OFFICIAL_LLM_RETRY_MAX_TOKENS="${VMP_OFFICIAL_LLM_RETRY_MAX_TOKENS:-8192}"
...
CANDIDATE_RUN_ID="${CANDIDATE_RUN_ID:-lme_test_${FRAMEWORK}_official_v3_candidates_seed42}"
RERANK_RUN_ID="${RERANK_RUN_ID:-lme_test_${FRAMEWORK}_official_v3_v64_rerank_seed42}"
DEV_PROTOCOL_RUN_ID="${DEV_PROTOCOL_RUN_ID:-lme_dev_${FRAMEWORK}_official_v3_protocol_seed42}"
...
MEM0_PROTOCOL_AUDIT_OUTPUT="${FRAMEWORK_AUDIT_OUTPUT}/mem0_protocol_v3.json"
